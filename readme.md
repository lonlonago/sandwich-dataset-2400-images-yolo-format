# Sandwich dataset (2400 images) YOLO format

# Body

Sandwich Dataset (2400 images in YOLO format) - electronic resource class, clear images, complete annotations, suitable for target detection model training, ready to use, saves time and effort.

The dataset contains a large number of sandwich images, annotation specifications, and supports YOLO format, making it convenient to train models.
